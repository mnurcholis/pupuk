<div>
    ...
    <div class="card">
        <div class="card-body">
            @if ($isEdit)
                <div class="row">
                    <div class="col-md-2 pr-0">
                        <div class="form-group">
                            <label>Invoice:</label>
                            <input type="text" class="form-control" value="{{ $transaksibeli->invoice ?? '' }}"
                                readonly>
                            @error('product_id')
                    ...
                    <div class="col-md-2 pl-0 pr-0">
                        <div class="form-group">
                            <label>Tanggal:</label>
                            <input type="text" class="form-control" value="{{ $transaksibeli->tanggal ?? '' }}"
                                readonly>
                        </div>
                    </div>
                    <div class="col-md-2 pl-0 pr-0">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                value="Rp. {{ number_format($transaksibeli->total ?? 0, 0, ',', '.') }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-2 pl-0 pr-0">
                        <div class="form-group">
                            <label>Bayar:</label>
                            <input type="text" class="form-control"
                                value="Rp. {{ number_format($transaksibeli->bayar ?? 0, 0, ',', '.') }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-2 pl-0 pr-0">
                        <div class="form-group">
                            <label>Sisa:</label>
                            <input type="text" class="form-control"
                                value="Rp. {{ number_format($transaksibeli->sisa ?? 0, 0, ',', '.') }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
                ...
                @endif
                @if ($transaksibeli->HutangVendor)
                    <div class="row">
                        <div class="col-md-2 pr-0">
                            <div class="form-group">
                                <label>Hutang Awal:</label>
                                <input type="text" class="form-control"
                                    value="Rp. {{ number_format($transaksibeli->HutangVendor->awal ?? 0, 0, ',', '.') }}"
                                    readonly>
                                @error('product_id')
                                    <span class="form-text text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-2 pl-0 pr-0">
                            <div class="form-group">
                                <label>Bayar :</label>
                                <input type="text" class="form-control"
                                    value="Rp. {{ number_format($transaksibeli->HutangVendor->bayar ?? 0, 0, ',', '.') }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-md-2 pl-0 pr-0">
                            <div class="form-group">
                                <label>Sisa :</label>
                                <input type="text" class="form-control"
                                    value="Rp. {{ number_format($transaksibeli->HutangVendor->sisa ?? 0, 0, ',', '.') }}"
                                    readonly>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @php
                                            $jumlah = 0;
                                        @endphp
                                        @foreach ($transaksibeli->HutangVendor->HutangVendorDetail as $a)
                                            <tr>
                                                <td>{{ $a['id'] }}</td>
                                                <td>{{ $a['tanggal'] }}</td>
    ...
    @else
        <livewire:admin.pages.hutang.data-hutang-vendor-table>
            @endif
    </div>
    @if ($beli)
                        ...
                        @can('harga_beli')
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Rp.
                                            {{ number_format($beli->HutangVendor->awal ?? $beli->total, 0, ',', '.') }}
                                        </td>
                                        <td>Rp.
                                            {{ number_format($beli->HutangVendor->bayar ?? $beli->bayar, 0, ',', '.') }}
                                        </td>
                                        <td>Rp.
                                            {{ number_format($beli->HutangVendor->sisa ?? $beli->sisa, 0, ',', '.') }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            <p class="mt-2"><strong>Detail Pembayaran:</strong></p>
                            @if ($beli->HutangVendor)
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Tanggal</th>
                                    ...
                                    <tbody>
                                        @foreach ($beli->HutangVendor->HutangVendorDetail as $val)
                                            <tr>
                                                <td>{{ $val->tanggal }}</td>
